...
set_keymap('n', 'tb', ':<C-u>NeoTreeFloatToggle<CR>',                                    { noremap = true,  silent = true })
...
set_keymap('n', 'tg', ':lua vim.lsp.buf.definition()<CR>',                               { noremap = true,  silent = true })
set_keymap('n', 'tG', ':lua vim.lsp.buf.references()<CR>',                               { noremap = true,  silent = true })
...
set_keymap('n', 'tK', ':lua vim.lsp.buf.code_action()<CR>',                              { noremap = true,  silent = true })
set_keymap('n', 'tl', ':lua vim.lsp.buf.formatting()<CR>',                               { noremap = true,  silent = true })
set_keymap('n', 'tL', ":<C-u>GHInteractive<CR>",                                         { noremap = true,  silent = true })
...
set_keymap('n', 'ts', '<Cmd>lua require"telescope.builtin".lsp_document_symbols{}<CR>',  { noremap = true,  silent = true })
set_keymap('n', 'tS', '<Cmd>lua require"telescope.builtin".lsp_workspace_symbols{}<CR>', { noremap = true,  silent = true })
set_keymap('n', 'tt', ':lua vim.lsp.buf.hover()<CR>',                                    { noremap = true,  silent = true })
set_keymap('n', 'tu', ':<C-u>Telescope registers<CR>',                                   { noremap = true,  silent = true })
set_keymap('n', 'tv', '<cmd>lua require("spectre").open_visual({select_word=true})<CR>', { noremap = true,  silent = true })
set_keymap('v', 'tv', '<cmd>lua require("spectre").open_visual({select_word=true})<CR>', { noremap = true,  silent = true })
...
set_keymap('n', 'tz', ':<C-u>noh<CR>',                                                   { noremap = true,  silent = true })
