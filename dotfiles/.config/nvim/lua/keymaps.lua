...
set_keymap('n', 'tf', ':lua vim.lsp.buf.formatting()<CR>',                           { noremap = true, silent = true})
...
set_keymap('n', 'tr', ':<C-u>Telescope command_history<CR>',                         { noremap = true, silent = true})
...
set_keymap('n', 'ty', ':<C-u>TroubleToggle<CR>',                                     { noremap = true,  silent = true})
