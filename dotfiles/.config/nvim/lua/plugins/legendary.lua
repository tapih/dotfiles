return function()
  require('legendary').setup {
    ...
    keymaps = {
      ...
      { '<leader>D',       ':lua vim.lsp.buf.type_definition()<CR>',                          mode = 'n', description = '[LSP] Go to type definition',                   opts = { remap = false, silent = true } },
      ...
      { "<leader>t",       ":<C-u>NeoTreeFloatToggle<CR>",                                    mode = "n", description = '[File] Open file tree on float windows',        opts = { remap = false, silent = true } },
      { "<leader>T",       ":<C-u>NeoTreeFocusToggle<CR>",                                    mode = "n", description = '[File] Open file tree on left',                 opts = { remap = false, silent = true } },
      ...
      { '<leader>,',       ':<C-u>TSJToggle<CR>',                                             mode = 'n', description = '[Edit] Convert single line <-> multi lines',    opts = { remap = false, silent = true } },
      ...
      { "<A-t>",           "<cmd>FloatermToggle<CR>",                                         mode = "n", description = '[Terminal] Toggle window',                      opts = { remap = false, silent = true } },
      { "<A-t>",           "<cmd>FloatermToggle<CR>",                                         mode = "t", description = '[Terminal] Toggle window',                      opts = { remap = false, silent = true } },
