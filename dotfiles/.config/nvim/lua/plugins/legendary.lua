return function()
  require('legendary').setup {
    keymaps = {
      ...
      { '<leader>m',       '<cmd>lua require("renamer").rename()<cr>',                        mode = 'n', description = '[Refactor] Rename',                             opts = { remap = false, silent = true } },
      { '<leader>m',       '<cmd>lua require("renamer").rename()<cr>',                        mode = 'v', description = '[Refactor] Rename',                             opts = { remap = false, silent = true } },
      ...
      { '<leader>s',       '<Cmd>lua require"telescope.builtin".lsp_document_symbols{}<CR>',  mode = 'n', description = '[LSP] Go to symbol in file',                    opts = { remap = false, silent = true } },
      { '<leader>S',       '<Cmd>lua require"telescope.builtin".lsp_workspace_symbols{}<CR>', mode = 'n', description = '[LSP] Go to symbol in project',                 opts = { remap = false, silent = true } },
